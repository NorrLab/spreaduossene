...
!function(e, t, n) {
    ...
    function() {
        ...
        function i(e) {
            return e.resolve || (e.resolve = e.when),
            e
        }
        ...
        o.$inject = ["$delegate"],
        i.$inject = ["$delegate"],
        t.module("material.core", ["ngAnimate", "material.core.animate", "material.core.layout", "material.core.interaction", "material.core.gestures", "material.core.theming"]).config(n).run(e)
    }(),
    function() {
        function e(e) {
            function n(n, o, i) {
              ...
              , C = {
                ...
                disableScrollAround: function(e, n, i) {
                    function r(e) {
                        ...
                        e = t.element(e || d);
                        var o;
                        return i.disableScrollMask ? o = e : (o = t.element('<div class="md-scroll-mask">  <div class="md-scroll-mask-bar"></div></div>'),
                        e.append(o)),
                        o.on("wheel", n),
                        o.on("touchmove", n),
                        function() {
                            o.off("wheel"),
                            o.off("touchmove"),
                            !i.disableScrollMask && o[0].parentNode && o[0].parentNode.removeChild(o[0])
                        }
                    }
                    function a() {
                        ...
                        d.clientWidth < a && (d.style.overflow = "hidden"),
                        s && (e.style.overflowY = "scroll"),
                        function() {
                            d.style.cssText = i,
                            e.style.cssText = n,
                            c.scrollTop = r
                    ...
                    if (i = i || {},
                    C.disableScrollAround._count = Math.max(0, C.disableScrollAround._count || 0),
                    C.disableScrollAround._count++,
                    C.disableScrollAround._restoreScroll)
                        return C.disableScrollAround._restoreScroll;
                    var d = o[0].body
                      , s = a()
                      , c = r(n);
                    return C.disableScrollAround._restoreScroll = function() {
                        --C.disableScrollAround._count <= 0 && (s(),
                        c(),
                        delete C.disableScrollAround._restoreScroll)
                    }
                },
                ...
                extractElementByName: function(e, n, o, i) {
                    ...
                    var s = r(e);
                    return !s && i && l.warn(C.supplant("Unable to find node '{0}' in element '{1}'.", [n, e[0].outerHTML])),
                    t.element(s || e)
                },
                ...
                getParentWithPointerEvents: function(e) {
                    for (var t = e.parent(); y(t, "pointer-events", "none"); )
                        t = t.parent();
                    return t
                },
    ...
    function() {
        ...
        function n(e, n, o, i) {
            function r(e, o, i) {
                ...
                i.length ? e.attr(o, i) : p && n.warn('ARIA: Attribute "', o, '", required for accessibility, is missing on node:', r))
            }
            function a(t, n, o) {
                e(function() {
                    r(t, n, o())
            ...
            function u(e, n) {
                ...
                return !!i.parentNode && (!!o(i.parentNode) || (n--,
                !!n && u(i.parentNode, n)))
            }
    ...
    function() {
        function e(e) {
            ...
            o.prototype._compileTemplate = function(e) {
                ...
                t.extend(r, a),
                o ? r.$$ngTemplate = this.$templateRequest(o) : r.$$ngTemplate = this.$q.when(i),
                this.$q.all(r).then(function(o) {
            ...
            o.prototype._compileElement = function(e, n, o) {
                function i(i) {
                    ...
                    o.controller) {
                        ...
                        n.children().data("$ngControllerController", c),
                        d.controller = c
                    }
                    return a(i)
                }
            ...
            o.prototype._createController = function(e, o, i) {
                ...
                var a = r();
                return !n() && e.bindToController && t.extend(r.instance, i),
                t.isFunction(a.$onInit) && a.$onInit(),
                a
            }
            ,
            o.prototype._fetchContentElement = function(e) {
                ...
                var o = e.contentElement
                  , i = null;
                return t.isString(o) ? (o = document.querySelector(o),
                i = n(o)) : (o = o[0] || o,
                i = document.contains(o) ? n(o) : function() {
        ...
        t.module("material.core").provider("$mdCompiler", e),
    ...
    function() {
        ...
        function o(n, o, i) {
            ...
            function a(e, t, n) {
                ...
                if (!o)
                    throw new Error("Failed to register element with handler " + t + ". Available handlers: " + Object.keys(f).join(", "));
            ...
            $.handler("focus", {
                ...
                onEnd: function(e, t) {
                    t.distance < this.state.options.maxDistance && u(e.target) && (this.dispatchEvent(e, "focus", t),
                    e.target.focus())
                }
            }),
            $.handler("mouseup", {
            ...
            $.handler("press", {
                ...
                onSetup: function(e, t) {
                    v && (this.oldTouchAction = e[0].style[v],
                    e[0].style[v] = t.horizontal ? "pan-y" : "pan-x")
                },
        ...
        function a(e, n) {
            function o(e) {
                ...
                t || e.$material || e.isIonicTap || c(e) || "mousedown" === e.type && (u(e.target) || u(document.activeElement)) || (e.preventDefault(),
                e.stopPropagation())
            }
            function i(e) {
                var t = 0 === e.clientX && 0 === e.clientY
                  , n = e.target && "submit" === e.target.type;
                t || e.$material || e.isIonicTap || c(e) || n ? (v = null,
                "label" == e.target.tagName.toLowerCase() && (v = {
                    x: e.x,
                    y: e.y
                })) : (e.preventDefault(),
                e.stopPropagation(),
            ...
            function a(e) {
                if (!p) {
                    var t = +Date.now();
                    h && !s(e, h) && t - h.endTime < 1500 || (p = d(e),
                    r("start", e))
                }
            }
            function m(e) {
            ...
            !E && e.isHijackingClicks && (document.addEventListener("click", i, !0),
    ...
    function() {
        function n(e, n) {
            this.$timeout = e,
            this.$mdUtil = n,
            this.bodyElement = t.element(document.body),
            this.isBuffering = !1,
        ...
        n.prototype.initializeEvents = function() {
            ...
            t && this.bodyElement.on(t, this.onInputEvent.bind(this))
        }
        ,
    ...
    function() {
        function e() {
                ...
                return function() {
                    ...
                    function h(e, t) {
                        function i(n) {
                            ...
                            return M.splice(M.indexOf(n), 1),
                            C.push(o),
                            n.deferred.promise
                        }
                        return t = t || {},
                        t.closeAll ? o.all(M.slice().reverse().map(i)) : t.closeTo !== n ? o.all(M.slice(t.closeTo).map(i)) : i(M[M.length - 1])
                    }
                    function f(e, n) {
                        var i = M.pop();
                        if (!i)
                    ...
                    function v(m) {
                        function u() {
                            return o(function(e, t) {
                                ...
                                m.onCompiling && m.onCompiling(m),
                                f(m).then(function(t) {
                                    M = g(t, m),
                                    m.cleanupElement = t.cleanup,
                                    T = $(M, m, t.controller).then(e, n)
                                })["catch"](n)
                            })
                        }
                        function p(e, n, i) {
                        ...
                        function b(n, o) {
                            ...
                            !(i || {}).length) {
                                var r;
                                return a[0] && a[0].querySelector && (r = a[0].querySelector(":not(svg) > body")),
                                r || (r = a[0]),
                        ...
                        function v() {
                            var e, o = t.noop;
                            m.hideDelay && (e = r(E.hide, m.hideDelay),
                            o = function() {
                                r.cancel(e)
                            }
                            ),
                        ...
                        function y(e, n) {
                            ...
                            return o(function(t, r) {
                                try {
                                    ...
                                    i(e, a),
                                    n.$destroy ? (t(e),
                                    !n.preserveScope && n.scope && a.then(function() {
                                        n.scope.$destroy()
                                    })) : a.then(function() {
            ...
            return o.$inject = ["$document", "$q", "$rootScope", "$timeout", "$rootElement", "$animate", "$mdUtil", "$mdCompiler", "$mdTheming", "$injector", "$exceptionHandler"],
            e.$get = o,
            e
        }
    ...
    function() {
        !function() {
            ...
            var g, b, v, E = /(-gt)?-(sm|md|lg|print)/g, $ = /\s+/g, y = ["grow", "initial", "auto", "none", "noshrink", "nogrow"], C = ["row", "column"], M = ["", "start", "center", "end", "stretch", "space-around", "space-between"], T = ["", "start", "center", "end", "stretch"], A = {
                enabled: !0,
                breakpoints: []
            };
    ...
    function() {
        ...
        e.$inject = ["$timeout"],
        t.module("material.core").service("$mdLiveAnnouncer", e),
    ...
    function() {
        !function(e) {
            ...
            function o(t, o) {
                ...
                function m(t, o, i, r) {
                    ...
                    l.defineTheme = function(e, t) {
                        t = t || {};
                        var n = s(e);
                        return t.primary && n.primaryPalette(t.primary),
                        t.accent && n.accentPalette(t.accent),
                        t.warn && n.warnPalette(t.warn),
                        t.background && n.backgroundPalette(t.background),
                        t.dark && n.dark(),
                ...
                m.$inject = ["$rootScope", "$mdUtil", "$q", "$log"],
                p = {};
                var h, E = {}, $ = !1, y = "default";
                e.extend(p, t);
                var M = function(e) {
                        ...
                        pre: function(d, s, c) {
                            var l = []
                              ...
                              , b = {
                                ...
                                $setTheme: function(e) {
                                    t.registered(e) || a.warn("attempted to use unregistered theme '" + e + "'"),
                                    b.$mdTheme = e;
            ...
            i.$inject = ["$mdTheming", "$interpolate", "$parse", "$mdUtil", "$q", "$log"],
            a.$inject = ["$mdTheming"],
            o.$inject = ["$mdColorPalette", "$$mdMetaProvider"],
            s.$inject = ["$injector", "$mdTheming"],
            e.module("material.core.theming", ["material.core.theming.palette", "material.core.meta"]).directive("mdTheme", i).directive("mdThemable", a).directive("mdThemesDisabled", r).provider("$mdTheming", o).config(t).run(s);
            var p, h = {}, f = {
                name: "dark",
                1: "rgba(0,0,0,0.87)",
                2: "rgba(0,0,0,0.54)",
            ...
            }, b = "1px 1px 0px rgba(0,0,0,0.4), -1px -1px 0px rgba(0,0,0,0.4)", v = "", E = m("rgba(0,0,0,0.87)"), $ = m("rgba(255,255,255,0.87)"), y = m("rgb(255,255,255)"), C = ["primary", "accent", "warn", "background"], M = "primary", T = {
                accent: {
                    "default": "A200",
                    "hue-1": "A100",
                    "hue-2": "A400",
    ...
    function() {
        ...
        n.$inject = ["$mdButtonInkRipple", "$mdTheming", "$mdAria", "$mdInteraction"],
        e.$inject = ["$mdTheming"],
        ...
        function e(e, n, o, i, r, a) {
            function d(d, s) {
                function c(d, s, c, l) {
                    ...
                    c.ngChecked && d.$watch(d.$eval.bind(d, c.ngChecked), function(e) {
                        v.$setViewValue(e),
                        v.$render()
                    }),
                    ...
                    s.on("click", p).on("keypress", u).on("focus", function() {
    ...
    function() {
        !function() {
            ...
            n.$inject = ["$mdColors", "$mdUtil", "$log", "$parse"],
    ...
    function() {
        ...
        function o(e) {
            ...
            function r(e, o, i, r, s, c, l, m, u, p, h, f, g) {
                ...
                function $(e, n, o) {
                    ...
                    function r() {
                        ...
                        o.cleanupElement(),
                        o.$destroy || "keyboard" !== o.originInteraction || o.origin.focus()
                    }
                ...
                function M(n, o) {
                    ...
                    if (o.escapeToClose) {
                        var m = o.parent
                          , u = function(e) {
                            e.keyCode === r.KEY_CODE.ESCAPE && (e.stopPropagation(),
                            e.preventDefault(),
                            c())
                        };
                        n.on("keydown", u),
                ...
                function T(e, t, n) {
                    ...
                    n.hideBackdrop = function(e) {
                        ...
                        n.disableParentScroll && (n.restoreScroll && n.restoreScroll(),
                ...
                function A(e, t) {
                    ...
                    a.classList.add("md-dialog-focus-trap"),
                    a.tabIndex = 0,
                    d = a.cloneNode(!1);
                    var l = function() {
                        e.focus()
                    ...
                    function n(e) {
                        for (; e.parentNode; ) {
                            ...
                            for (var t = e.parentNode.children, i = 0; i < t.length; i++)
                                e === t[i] || N(t[i], ["SCRIPT", "STYLE"]) || t[i].hasAttribute("aria-live") || t[i].setAttribute("aria-hidden", o);
                            n(e = e.parentNode)
                        }
                    }
                    var o = !0;
                ...
                function _(e, t) {
                    t.parent.append(e),
                    t.reverseContainerStretch = k(e, t);
                    var n = e.find("md-dialog")
                      ...
                      , s = o.toTransformCss("");
                    return n.toggleClass("md-dialog-fullscreen", !!t.fullscreen),
                    o.translate3d(n, d, s, a).then(function(e) {
                        ...
                        t.clearAnimate = function() {
                            ...
                            n.removeClass([a.transitionOutClass, a.transitionInClass].join(" ")),
            ...
            i.$inject = ["$mdDialog", "$mdConstant"],
            r.$inject = ["$mdDialog", "$mdAria", "$mdUtil", "$mdConstant", "$animate", "$document", "$window", "$rootElement", "$log", "$injector", "$mdTheming", "$interpolate", "$mdInteraction"];
            var a, d;
    ...
    function() {
        !function() {
            function e(e, n, o, i, r, a) {
                ...
                function E(e, n) {
                    var o = $();
                    N.currentActionIndex = N.currentActionIndex + n,
                    N.currentActionIndex = Math.min(o.length - 1, N.currentActionIndex),
                    N.currentActionIndex = Math.max(0, N.currentActionIndex);
        ...
        function e(e, o, i, r) {
            function a(n, a, d, s) {
                ...
                var M = t.bind(s, s.invalidateLayout)
                  , T = c();
                n.$on("$destroy", l);
                var A, w = e.startSymbol(), k = e.endSymbol(), _ = e(p("share") + "% - (" + p("gutter") + " * " + p("gutterShare") + ")"), x = e("calc((" + p("unit") + " + " + p("gutter") + ") * " + p("offset") + ")"), N = e("calc((" + p("unit") + ") * " + p("span") + " + (" + p("span") + " - 1) * " + p("gutter") + ")")
            }
            return {
                restrict: "E",
                controller: n,
    ...
    function() {
        function n(e, t) {
            function n(t) {
                ...
                return n && t.addClass("md-icon-left"),
                o && t.addClass("md-icon-right"),
                function(t, n) {
                    e(n)
                }
            }
        ...
        function i(e, n, o, i, r) {
            function a(a, d, s, c) {
                ...
                function p() {
                    ...
                    function u() {
                        function e(e) {
                            ...
                            l = !0,
                            u = e.clientY,
                            p = parseFloat(d.css("height")) || d.prop("offsetHeight")
                        }
                        function n(e) {
                            l && (e.preventDefault(),
                            m(),
                            f.addClass("md-input-resized"))
                        }
                        function o(e) {
                        ...
                        function i(e) {
                            l && (l = !1,
                            f.removeClass("md-input-resized"))
                        }
                        if (!s.hasOwnProperty("mdNoResize")) {
                            ...
                            d.wrap('<div class="md-resize-wrapper">').after(c),
                            c.on("mousedown", e),
                            f.on("$md.dragstart", n).on("$md.drag", o).on("$md.dragend", i),
                            a.$on("$destroy", function() {
                                c.off("mousedown", e).remove(),
                                f.off("$md.dragstart", n).off("$md.drag", o).off("$md.dragend", i),
                                g(),
                                c = null,
                                f = null,
                                g = null
                ...
                if (h) {
                    ...
                    h.label || C.length || o.expect(d, "aria-label"),
                    d.addClass("md-input"),
        ...
        function p(e, n) {
            ...
            return 0 == r.length || 0 == a.length ? (T.warn("mdInput messages show animation called on invalid messages element: ", e),
            void n()) : (t.forEach(a, function(e) {
                o = f(t.element(e)),
                i.push(o.start())
            }),
            void y.all(i, n))
        ...
        function h(e, n) {
            var o, i = [], r = v(e), a = r.children();
            return 0 == r.length || 0 == a.length ? (T.warn("mdInput messages hide animation called on invalid messages element: ", e),
            void n()) : (t.forEach(a, function(e) {
                o = g(t.element(e)),
                i.push(o.start())
            }),
        ...
        c.$inject = ["$mdUtil"],
        d.$inject = ["$timeout"],
        l.$inject = ["$$AnimateRunner", "$animateCss", "$mdUtil", "$log"],
        m.$inject = ["$$AnimateRunner", "$animateCss", "$mdUtil", "$log"],
        u.$inject = ["$$AnimateRunner", "$animateCss", "$mdUtil", "$log"];
            ...
            return {
                ...
                compile: function(a, d) {
                    ...
                    function c() {
                        ...
                        g(i[0]) || i.attr("ng-click", "$mdMenu.open($event)"),
                        i.attr("aria-label") || i.attr("aria-label", "Open List Menu")
                    }
                    function l(n) {
                        if ("div" == n)
                            y = t.element('<div class="md-no-style md-list-item-inner">'),
                            y.append(a.contents()),
                            ...
                            p(a[0], o[0]),
                            o.attr("aria-label") || o.attr("aria-label", e.getText(a)),
                            a.hasClass("md-no-focus") && o.addClass("md-no-focus"),
                            y.prepend(o),
                            y.children().eq(1).append(a.contents()),
                    ...
                    function b(e, a, d, s) {
                        ...
                        b || u.length || f && f.addEventListener("keypress", E),
                        a.off("click"),
                        a.off("keypress"),
        ...
        function e(e, n) {
            return {
                ...
                link: function(o, i, r, a) {
                    n(i),
                    a.navBarAriaLabel || e.expectAsync(i, "aria-label", t.noop)
                }
            }
        }
        function o(e, t, n, o) {
        ...
        function i(e, n) {
            return {
                ...
                template: function(e, t) {
                    ...
                    return r ? n = 'ng-click="ctrl.mdNavClick()"' : a ? n = 'ng-href="{{ctrl.mdNavHref}}"' : d && (n = 'ui-sref="{{ctrl.mdNavSref}}"'),
                    o = s ? 'ui-sref-opts="{{ctrl.srefOpts}}" ' : "",
                    n && (i = '<md-button class="_md-nav-button md-accent" ng-class="ctrl.getNgClassMap()" ng-blur="ctrl.setFocused(false)" tabindex="-1" ' + o + n + '><span ng-transclude class="_md-nav-button-text"></span></md-button>'),
    ...
    function() {
        ...
        function d(e, n, o, i, r) {
            ...
            this.absPosition = c.absPosition
        }
        function s(e, t) {
            this._$q = t.get("$q"),
        ...
        t.module("material.components.panel", ["material.core", "material.components.backdrop"]).provider("$mdPanel", e);
        var p = 80
          , h = "_md-panel-hidden"
          , f = t.element('<div class="_md-panel-focus-trap" tabindex="0"></div>')
          , g = {};
        d.prototype.create = function(e, n) {
            if ("string" == typeof e ? e = this._getPresetByName(e) : "object" != typeof e || !t.isUndefined(n) && n || (n = e,
            e = {}),
            e = e || {},
            n = n || {},
            t.isDefined(n.id) && this._trackedPanels[n.id]) {
                var o = this._trackedPanels[n.id];
                return t.extend(o.config, n),
                o
            }
            ...
            return this._trackedPanels[n.id] = i,
            this._config.groupName && (t.isString(this._config.groupName) && (this._config.groupName = [this._config.groupName]),
            t.forEach(this._config.groupName, function(e) {
                i.addToGroup(e)
            })),
            this._config.scope.$on("$destroy", t.bind(i, i.detach)),
            i
        }
        ,
        ...
        s.prototype.close = function(e) {
            ...
            return this._$q(function(o, i) {
                n._callInterceptors(s.interceptorTypes.CLOSE).then(function() {
                    ...
                    d = t.bind(n, d, n, e),
                    n.hide().then(a).then(r).then(d)["catch"](i)
                }, i)
            })
        }
        ,
        ...
        s.prototype.detach = function() {
            ...
            var e = this
              ...
              , o = function() {
                ...
                e.panelEl[0].style.cssText = e._restoreCache.styles || "",
                e._compilerCleanup(),
                e.panelContainer.remove(),
                e.isAttached = !1,
                e._$q.when(e)
            };
        ...
        s.prototype.show = function() {
            ...
            var e = this
              , n = function() {
                return e.panelContainer.removeClass(h),
                e._animateOpen()
            };
            return this._$q(function(o, i) {
                var r = e._done(o, e)
                  ...
                  , d = function() {
                    if (e.config.groupName) {
                        ...
                        t.forEach(e.config.groupName, function(t) {
                            ...
                            n = t.openPanels.indexOf(e),
                            n > -1 && t.openPanels.splice(n, 1)
                        })
                    }
                }
                  , s = function() {
        ...
        s.prototype.addClass = function(e, t) {
            if (this._$log.warn("mdPanel: The addClass method is in the process of being deprecated. Full deprecation is scheduled for the AngularJS Material 1.2 release. To achieve the same results, use the panelContainer or panelEl JQLite elements that are referenced in MdPanelRef."),
            !this.panelContainer)
        ...
        s.prototype.removeClass = function(e, t) {
            if (this._$log.warn("mdPanel: The removeClass method is in the process of being deprecated. Full deprecation is scheduled for the AngularJS Material 1.2 release. To achieve the same results, use the panelContainer or panelEl JQLite elements that are referenced in MdPanelRef."),
            !this.panelContainer)
                throw new Error("mdPanel: Panel does not exist yet. Call open() or attach().");
        ...
        s.prototype.toggleClass = function(e, t) {
            if (this._$log.warn("mdPanel: The toggleClass method is in the process of being deprecated. Full deprecation is scheduled for the AngularJS Material 1.2 release. To achieve the same results, use the panelContainer or panelEl JQLite elements that are referenced in MdPanelRef."),
            !this.panelContainer)
                throw new Error("mdPanel: Panel does not exist yet. Call open() or attach().");
        ...
        s.prototype._compile = function() {
            ...
            return e._$mdCompiler.compile(e.config).then(function(n) {
                ...
                if (o.contentElement) {
                    var i = n.element;
                    e._restoreCache.styles = i[0].style.cssText,
                    e._restoreCache.classes = i[0].className,
                    e.panelContainer = e._$mdPanel._wrapContentElement(i),
                    e.panelEl = i
                } else
                    e.panelContainer = n.link(o.scope),
                    e.panelEl = t.element(e.panelContainer[0].querySelector(".md-panel"));
                return e._compilerCleanup = n.cleanup,
                m(e.config.attachTo).append(e.panelContainer),
                e
            })
        }
        ,
        s.prototype._createPanel = function() {
            ...
            return this._$q(function(t, n) {
                ...
                e._compile().then(function() {
                    e.config.disableParentScroll && (e._restoreScroll = e._$mdUtil.disableScrollAround(null, e.panelContainer, {
                        disableScrollMask: !0
                    })),
                    e.config.panelClass && e.panelEl.addClass(e.config.panelClass),
                    e.config.propagateContainerEvents && (e.panelContainer.css("pointer-events", "none"),
                    e.panelEl.css("pointer-events", "all")),
                    e._$animate.pin && e._$animate.pin(e.panelContainer, m(e.config.attachTo)),
        ...
        s.prototype._addStyles = function() {
            ...
            return this._$q(function(t) {
                ...
                var n = function() {
                    e._setTheming(),
                    e.panelEl.removeClass("_md-panel-offscreen"),
                    e.panelContainer.addClass(h),
                    t(e)
                };
                if (e.config.fullscreen)
                    return e.panelEl.addClass("_md-panel-fullscreen"),
                    void n();
        ...
        s.prototype._updatePosition = function(e) {
            ...
            t && (t._setPanelPosition(this.panelEl),
            e && (this.panelEl.removeClass("_md-panel-offscreen"),
            this.panelContainer.addClass(h)),
        ...
        s.prototype._configureClickOutsideToClose = function() {
            if (this.config.clickOutsideToClose) {
                var e, n = this.config.propagateContainerEvents ? t.element(document.body) : this.panelContainer, o = function(t) {
                    e = t.target
                }, i = this, r = function(t) {
                    i.config.propagateContainerEvents ? e === i.panelEl[0] || i.panelEl[0].contains(e) || i.close() : e === n[0] && t.target === n[0] && (t.stopPropagation(),
                    t.preventDefault(),
                    i.close(s.closeReasons.CLICK_OUTSIDE))
                };
                n.on("mousedown", o),
                n.on("mouseup", r),
                this._removeListeners.push(function() {
        ...
        s.prototype._configureTrapFocus = function() {
            ...
            this.config.trapFocus) {
                var e = this.panelEl;
                this._topFocusTrap = f.clone()[0],
                this._bottomFocusTrap = f.clone()[0];
                var t = function() {
                    e.focus()
                };
        ...
        s.prototype.updateAnimation = function(e) {
            ...
            this._backdropRef && this._backdropRef.config.animation.duration(e._rawDuration)
        }
        ,
        s.prototype._animateOpen = function() {
            ...
            if (!e)
                return this.panelContainer.addClass("_md-panel-shown"),
                this._$q.when(this);
            var t = this;
            return this._$q(function(n) {
                var o = t._done(n, t)
                  , i = function() {
                    t._$log.warn("mdPanel: MdPanel Animations failed. Showing panel without animating."),
                    o()
                };
        ...
        s.prototype._animateClose = function() {
            var e = this.config.animation;
            if (!e)
                return this.panelContainer.removeClass("md-panel-is-showing"),
                this.panelContainer.removeClass("_md-panel-shown"),
                this._$q.when(this);
            var t = this;
            return this._$q(function(n) {
                var o = function() {
                    t.panelContainer.removeClass("md-panel-is-showing"),
                    n(t)
                }
                  , i = function() {
                    t._$log.warn("mdPanel: MdPanel Animations failed. Hiding panel without animating."),
                    o()
                };
        ...
        s.prototype.registerInterceptor = function(e, n) {
            var o = null;
            if (t.isString(e) ? t.isFunction(n) || (o = "Interceptor callback must be a function, instead got " + typeof n) : o = "Interceptor type must be a string, instead got " + typeof e,
            o)
                throw new Error("MdPanel: " + o);
            var i = this._interceptors[e] = this._interceptors[e] || [];
            return i.indexOf(n) === -1 && i.push(n),
            this
        }
        ,
        s.prototype.removeInterceptor = function(e, t) {
            var n = this._interceptors[e] ? this._interceptors[e].indexOf(t) : -1;
            return n > -1 && this._interceptors[e].splice(n, 1),
            this
        }
        ,
        s.prototype.removeAllInterceptors = function(e) {
            return e ? this._interceptors[e] = [] : this._interceptors = Object.create(null),
            this
        }
        ,
        ...
        c.prototype._setPanelPosition = function(e) {
            ...
            if (this._actualPosition)
                return this._calculatePanelPosition(e, this._actualPosition),
        ...
        l.prototype.duration = function(e) {
            ...
            return e && (t.isNumber(e) ? this._openDuration = this._closeDuration = n(e) : t.isObject(e) && (this._openDuration = n(e.open),
            this._closeDuration = n(e.close))),
            this._rawDuration = e,
            this
        }
        ,
        ...
        l.prototype.animateOpen = function(e) {
            ...
            return o.duration = this._openDuration,
            n.translate3d(e, r, a, o)
        }
        ,
        l.prototype.animateClose = function(e) {
            ...
            return o.duration = this._closeDuration,
            n.translate3d(e, r, a, o)
        }
        ,
    ...
    function() {
        function e(e, n, o) {
            ...
            function r(o, i, r) {
                ...
                e(i);
                var g, b = r.hasOwnProperty("disabled"), v = n.dom.animator.toCss, E = t.element(i[0].querySelector(".md-bar1")), $ = t.element(i[0].querySelector(".md-bar2")), y = t.element(i[0].querySelector(".md-container"));
        ...
        function n(e, t, n) {
            function o(o, r, a, d) {
                ...
                function l() {
                    ...
                    e !== u && ("md-radio-group" !== r[0].parentNode.nodeName.toLowerCase() && r.parent().toggleClass(i, e),
                    e && d.setActiveDescendant(r.attr("id")),
                    u = e,
                    r.attr("aria-checked", e).toggleClass(i, e))
                }
                function m(n, o) {
                    n.attr({
    ...
    function() {
        function o(e, o, i, r, a, d, s, l) {
            function m(l, m) {
                ...
                u.append('<span class="md-select-icon" aria-hidden="true"></span>'),
                u.addClass("md-select-value"),
                u[0].hasAttribute("id") || u.attr("id", "select_value_label_" + o.nextUid());
                var p = l.find("md-content");
                if (p.length || l.append(t.element("<md-content>").append(l.contents())),
                p.attr("role", "presentation"),
                m.mdOnOpen && (l.find("md-content").prepend(t.element('<div> <md-progress-circular md-mode="indeterminate" ng-if="$$loadingAsyncDone === false" md-diameter="25px"></md-progress-circular></div>')),
                ...
                m.name) {
                    ...
                    h.append('<option ng-value="' + m.ngModel + '" selected></option>'),
                    l.parent().append(h);
                }
                ...
                return v = o.supplant(v, [b, l.html()]),
                l.empty().append(u),
                l.append(v),
                ...
                function(l, m, u, p) {
                    function h() {
                        ...
                        !e && A && A.label && (e = A.label.text()),
                        M = e,
                        a.expect(m, "aria-label", e)
                    }
                    function f() {
                        I && (O = O || I.find("md-select-menu").controller("mdSelectMenu"),
                        w.setLabelText(O.selectedLabels()))
                    }
                    function b() {
                        if (M) {
                    ...
                    function E() {
                        if (I = t.element(m[0].querySelector(".md-select-menu-container")),
                        H = l,
                        u.mdContainerClass) {
                            var e = I[0].getAttribute("class") + " " + u.mdContainerClass;
                            I[0].setAttribute("class", e)
                        }
                        O = I.find("md-select-menu").controller("mdSelectMenu"),
                        O.init(k, u.ngModel),
                    ...
                    function $(e) {
                        if (i.isNavigationKey(e))
                            ...
                            O.isMultiple || O.deselect(Object.keys(O.selected)[0]),
                            O.select(o.hashKey, o.value),
                            O.refreshViewValue()
                        }
                    }
                    function y() {
                    ...
                    var C, M, T = !0, A = p[0], w = p[1], k = p[2], _ = p[3], x = m.find("md-select-value"), N = t.isDefined(u.readonly), S = o.parseAttributeBoolean(u.mdNoAsterisk);
                    if (S && m.addClass("md-no-asterisk"),
                    A) {
                        var D = A.isErrorGetter || function() {
                            return k.$invalid && (k.$touched || _ && _.$submitted)
                        }
                        ;
                        if (A.input && m.find("md-select-header").find("input")[0] !== A.input[0])
                            throw new Error("<md-input-container> can only have *one* child <input>, <textarea> or <select> element!");
                        A.input = m,
                        A.label || a.expect(m, "aria-label", m.attr("placeholder")),
                        l.$watch(D, A.setInvalid)
                    }
                    var I, H, O;
                    E(),
                    r(m),
                    _ && t.isDefined(u.multiple) && o.nextTick(function() {
                    ...
                    w.setIsPlaceholder = function(e) {
                        e ? (x.addClass("md-select-placeholder"),
                        A && A.label && A.label.addClass("md-placeholder")) : (x.removeClass("md-select-placeholder"),
                        A && A.label && A.label.removeClass("md-placeholder"))
                    }
                    ,
                    ...
                    m.on("blur", function(e) {
                        T && (T = !1,
                        H._mdSelectIsOpen && e.stopImmediatePropagation()),
                        H._mdSelectIsOpen || (A && A.setFocused(!1),
                        v())
                    })),
                    ...
                    u.$observe("ngMultiple", function(e) {
                        ...
                        L = l.$watch(function() {
                            ...
                            e === n && t === n || (e ? m.attr("multiple", "multiple") : m.removeAttr("multiple"),
                            m.attr("aria-multiselectable", e ? "true" : "false"),
                            I && (O.setMultiple(e),
                            P = k.$render,
                            k.$render = function() {
                                P(),
                    ...
                    I.attr("id", F),
                    m.find("md-select-menu").length || (R["aria-owns"] = F),
                    m.attr(R),
        ...
        function i(e, o, i, r) {
            ...
            function d(r, a, d) {
                ...
                var l = this;
                l.isMultiple = t.isDefined(a.multiple),
                l.selected = {},
                l.options = {},
                ...
                l.addOption = function(e, n) {
                    ...
                    t.isDefined(l.ngModel.$modelValue) && l.hashGetter(l.ngModel.$modelValue) === e && l.ngModel.$validate(),
                    l.refreshViewValue())
                }
                ,
                ...
                l.refreshViewValue = function() {
                    ...
                    (r ? t.equals(d, a) : d + "" === a) || (l.ngModel.$setViewValue(a),
                    l.ngModel.$render())
                }
            }
        ...
        function r(e, n, o) {
            ...
            function a(i, r, a, d) {
                function s(e, t, n) {
                    if (!m.hashGetter)
                        return void (n || i.$$postDigest(function() {
                            s(e, t, !0)
                        }));
                ...
                var l = d[0]
                  , m = d[1];
                o(r),
                m.isMultiple && (r.addClass("md-checkbox-enabled"),
                r.prepend(u.clone())),
                t.isDefined(a.ngValue) ? i.$watch(a.ngValue, s) : t.isDefined(a.value) ? s(a.value) : i.$watch(function() {
                    return r.text().trim()
                }, s),
                ...
                i.$$postDigest(function() {
                    a.$observe("selected", function(e) {
                        ...
                        e ? (m.isMultiple || m.deselect(Object.keys(m.selected)[0]),
                        m.select(l.hashKey, l.value)) : m.deselect(l.hashKey),
                        m.refreshViewValue())
                    })
                }),
                e.attach(i, r),
        ...
        function s(o) {
            function i(o, i, m, u, p, h, f, g, b) {
                function v(e, t, n) {
                    ...
                    function i() {
                        a(),
                        t.removeClass("md-active").attr("aria-hidden", "true").css("display", "none"),
                ...
                function E(e, r, a) {
                    function d(e, t, n) {
                        return n.parent !== t.parent() && t.parent().attr("aria-owns", t.attr("id")),
                        t.parent().find("md-select-value").attr("aria-hidden", "true"),
                        n.parent.append(t),
                        p(function(e, n) {
                            try {
                                f(t, {
                    ...
                    function s() {
                        return p(function(t) {
                            if (a.isRemoved)
                                return p.reject(!1);
                            var n = y(e, r, a);
                            n.container.element.css(M.toCss(n.container.styles)),
                            n.dropDown.element.css(M.toCss(n.dropDown.styles)),
                            h(function() {
                                r.addClass("md-active"),
                                n.dropDown.element.css(M.toCss({
                                    transform: ""
                                })),
                                t()
                            })
                    ...
                    function l(e, t, n) {
                        return n.disableParentScroll && !m.getClosest(n.target, "MD-DIALOG") ? n.restoreScroll = m.disableScrollAround(n.element, n.parent) : n.disableParentScroll = !1,
                        n.hasBackdrop && (n.backdrop = m.createBackdrop(e, "md-select-backdrop md-click-catcher"),
                        g.enter(n.backdrop, b[0].body, null, {
                            duration: 0
                        })),
                        function() {
                    ...
                    function E(e, n) {
                        ...
                        if (!n.target)
                            throw new Error(m.supplant(C, [n.target]));
                        t.extend(n, {
                            isRemoved: !1,
                    ...
                    function A() {
                        ...
                        p.when(a.loadingAsync).then(function() {
                ...
                function y(n, o, i) {
                    var c, p = o[0], h = i.target[0].children[0], f = b[0].body, g = i.selectEl[0], v = i.contentEl[0], E = f.getBoundingClientRect(), $ = h.getBoundingClientRect(), y = !1, C = {
                        left: E.left + l,
                        top: l,
                        bottom: E.height - l,
                    ...
                    }, T = E.width - 2 * l, A = g.querySelector("md-option[selected]"), w = g.getElementsByTagName("md-option"), k = g.getElementsByTagName("md-optgroup"), _ = s(o, v), x = r(i.loadingAsync);
                    c = x ? v.firstElementChild || v : A ? A : k.length ? k[0] : w.length ? w[0] : v.firstElementChild || v,
                    v.offsetWidth > T ? v.style["max-width"] = T + "px" : v.style.maxWidth = null,
                    y && (v.style["min-width"] = $.width + "px"),
                    _ && g.classList.add("md-overflow");
                    var N = c;
                    "MD-OPTGROUP" === (N.tagName || "").toUpperCase() && (N = w[0] || v.firstElementChild || v,
                    c = N),
                    i.focusedNode = N,
                    ...
                    if (c) {
                        ...
                        D.paddingLeft = parseInt(I.paddingLeft, 10) || 0,
                        D.paddingRight = parseInt(I.paddingRight, 10) || 0
                    }
                    if (_) {
                        var H = v.offsetHeight / 2;
                        v.scrollTop = D.top + D.height / 2 - H,
                        M.top < H ? v.scrollTop = Math.min(D.top, v.scrollTop + H - M.top) : M.bottom < H && (v.scrollTop = Math.max(D.top + D.height - S.height, v.scrollTop - H + M.bottom))
                    }
                    var O, P, L, R, F;
                    y ? (O = $.left,
                    P = $.top + $.height,
                    L = "50% 0",
                    P + S.height > C.bottom && (P = $.top - S.height,
                    L = "50% 100%")) : (O = $.left + D.left - D.paddingLeft + 2,
                    P = Math.floor($.top + $.height / 2 - D.height / 2 - D.top + v.scrollTop) + 2,
                    L = D.left + $.width / 2 + "px " + (D.top + D.height / 2 - v.scrollTop) + "px 0px",
                    R = Math.min($.width + D.paddingLeft + D.paddingRight, T),
        ...
        o.$inject = ["$mdSelect", "$mdUtil", "$mdConstant", "$mdTheming", "$mdAria", "$parse", "$sce", "$injector"],
        i.$inject = ["$parse", "$mdUtil", "$mdConstant", "$mdTheming"],
        r.$inject = ["$mdButtonInkRipple", "$mdUtil", "$mdTheming"],
    ...
    function() {
        ...
        function i(e, o, i, r, a, d, s, c, l, m, u, p, h) {
            function f(s, f, g, b) {
                function v(e, t) {
                    s.isLockedOpen = e,
                    e === t ? f.toggleClass("md-locked-open", !!e) : d[e ? "addClass" : "removeClass"](f, "md-locked-open"),
                    w && w.toggleClass("md-locked-open", !!e)
                }
                function E(e) {
                    var t = o.findFocusTarget(f) || o.findFocusTarget(f, "[md-sidenav-focus]") || f
                      , n = f.parent();
                    n[e ? "on" : "off"]("keydown", M),
                    w && w[e ? "on" : "off"]("click", T);
                    var i = $(n, e);
                    return e && (N = u[0].activeElement,
                    k = a.getLastInteractionType()),
                    y(e),
                    S = m.all([e && w ? d.enter(w, n) : w ? d.leave(w) : m.when(!0), d[e ? "removeClass" : "addClass"](f, "md-closed")]).then(function() {
                        s.isOpen && (h(function() {
                ...
                function $(e, t) {
                    ...
                    if (!t && _)
                        return function() {
                            n.style.top = _.top,
                            n.style.bottom = _.bottom,
                            n.style.height = _.height,
                            w[0].style.top = null,
                            w[0].style.bottom = null,
                            w[0].style.height = null,
                            _ = null
                        }
                }
                function y(e) {
                    e && !A ? (A = x.css("overflow"),
                    x.css("overflow", "hidden")) : t.isDefined(A) && (x.css("overflow", A),
                    A = n)
                }
                function C(e) {
                    return s.isOpen == e ? m.when(!0) : (s.isOpen && b.onCloseCb && b.onCloseCb(),
                    m(function(t) {
                        s.isOpen = e,
                        o.nextTick(function() {
                            S.then(function(e) {
                                !s.isOpen && N && "keyboard" === k && (N.focus(),
                                N = null),
                                t(e)
                            })
                        })
                ...
                var A, w, k, _, x = null, N = null, S = m.when(!0), D = c(g.mdIsLockedOpen), I = t.element(p), H = function() {
                    return D(s.$parent, {
                        $media: function(t) {
                            return l.warn("$media is deprecated for is-locked-open. Use $mdMedia instead."),
                            e(t)
                        },
                        $mdMedia: e
                    })
                };
                g.mdDisableScrollTarget && (x = u[0].querySelector(g.mdDisableScrollTarget),
                x ? x = t.element(x) : l.warn(o.supplant('mdSidenav: couldn\'t find element matching selector "{selector}". Falling back to parent.', {
                    selector: g.mdDisableScrollTarget
                }))),
                x || (x = f.parent()),
                g.hasOwnProperty("mdDisableBackdrop") || (w = o.createBackdrop(s, "md-sidenav-backdrop md-opaque ng-enter")),
                f.addClass("_md"),
                r(f),
                w && r.inherit(w, f),
        ...
        function r(e, t, n, o, i) {
            ...
            d && t.$observe("mdComponentId", function(e) {
                e && e !== r.$$mdHandle && (r.destroy(),
                r.destroy = n.register(r, e))
            })
        }
        e.$inject = ["$mdComponentRegistry", "$mdUtil", "$q", "$log"],
        i.$inject = ["$mdMedia", "$mdUtil", "$mdConstant", "$mdTheming", "$mdInteraction", "$animate", "$compile", "$parse", "$log", "$q", "$document", "$window", "$$rAF"],
        r.$inject = ["$scope", "$attrs", "$mdComponentRegistry", "$q", "$interpolate"],
    ...
    function() {
        ...
        function o(e, n, o, i, r, a, d, s, c, l) {
            ...
            function u(o, m, u, p) {
                ...
                o.mouseActive = !1,
                ee.on("keydown", T).on("mousedown", A).on("focus", w).on("blur", k).on("$md.pressdown", I).on("$md.pressup", H).on("$md.dragstart", O).on("$md.drag", P).on("$md.dragend", L),
                setTimeout(h, 0);
                var de = e.throttle(h);
        ...
        function e(e, n, o, i, r) {
            return {
                ...
                link: function(a, d, s, c, l) {
                    ...
                    o(d),
                    d.addClass("_md"),
                    i.prefixer().removeAttribute(d, "ng-repeat");
                    var u = d[0].outerHTML;
                    s.$set("role", "heading"),
                    r.expect(d, "aria-level", "2"),
                    l(a, function(e) {
                        m(d).append(e)
                    }),
                ...
                function(e, s, c, m) {
                    ...
                    function p(e) {
                        if (y) {
                            ...
                            v.css(o.CSS.TRANSFORM, "translate3d(" + 100 * n + "%,0,0)"),
                            y.translate = n
                        }
                    }
                    function h(t) {
                    ...
                    c.$observe("mdInvert", function(e) {
                        ...
                        t ? s.prepend($) : s.prepend(E),
                        s.toggleClass("md-inverted", t)
                    }),
                    a.register(E, "drag"),
                    E.on("$md.dragstart", u).on("$md.drag", p).on("$md.dragend", h);
                    var y
                }
            }
            var c = e[0];
    ...
    function() {
        ...
        function n(e) {
            ...
            o.$inject = ["$mdToast", "$scope"],
            i.$inject = ["$animate", "$mdToast", "$mdUtil", "$mdMedia"];
            ...
            return {
                ...
                link: function(d, s, c) {
                    function l() {
                        ...
                        var h, f, g = t.noop, b = 0, v = 0, E = c.mdShrinkSpeedFactor || .5, $ = e.throttle(m), y = o.debounce(p, 5e3);
    ...
    function() {
        function n(e, n, o, i, r, a, d, s) {
            function c(c, g, b) {
                function v() {
                    c.mdZIndex = c.mdZIndex || u,
                    c.mdDelay = c.mdDelay || p,
                    f[c.mdDirection] || (c.mdDirection = h)
                }
                function E(e) {
                    var t = e || r(g.text().trim())(c.$parent);
                    (!H.attr("aria-label") && !H.attr("aria-labelledby") || H.attr("md-labeled-by-tooltip")) && (H.attr("aria-label", t),
                    H.attr("md-labeled-by-tooltip") || H.attr("md-labeled-by-tooltip", I))
                }
                function $() {
                    v(),
                    N && N.panelEl && N.panelEl.removeClass(k),
                    k = "md-origin-" + c.mdDirection,
                    _ = f[c.mdDirection],
                    x = d.newPanelPosition().relativeTo(H).addPanelPosition(_.x, _.y),
                    N && N.panelEl && (N.panelEl.addClass(k),
                    N.updatePosition(x))
                }
                function y() {
                    function t(e) {
                    ...
                    function d(e) {
                        "focus" === e.type && L ? L = !1 : c.mdVisible || (H.on(m, u),
                        M(!0),
                        "touchstart" === e.type && H.one("touchend", function() {
                            a.nextTick(function() {
                                i.one("touchend", u)
                            }, !1)
                        }))
                    ...
                    function u() {
                        S = c.hasOwnProperty("mdAutohide") ? c.mdAutohide : b.hasOwnProperty("mdAutohide"),
                        (S || P || i[0].activeElement !== H[0]) && (D && (e.cancel(D),
                        M.queued = !1,
                        D = null),
                        H.off(m, u),
                    ...
                    function h() {
                        s.deregister("scroll", o, !0),
                        s.deregister("blur", r),
                        s.deregister("resize", O),
                        H.off(l, d).off(m, u).off("mousedown", p),
                        u(),
                        f && f.disconnect()
                    }
                ...
                function C() {
                    ...
                    if (g[0] && "MutationObserver"in n) {
                        ...
                        c.visibleWatcher = c.$watch("mdVisible", T);
                    c.$watch("mdDirection", $),
                    g.one("$destroy", e),
                    H.one("$destroy", e),
                    c.$on("$destroy", function() {
                ...
                function M(t) {
                    M.queued && M.value === !!t || !M.queued && c.mdVisible === !!t || (M.value = !!t,
                    M.queued || (t ? (M.queued = !0,
                    D = e(function() {
                        c.mdVisible = M.value,
                        M.queued = !1,
                        D = null,
                        c.visibleWatcher || T(c.mdVisible)
                    }, c.mdDelay)) : a.nextTick(function() {
                        c.mdVisible = !1,
                        c.visibleWatcher || T(!1)
                    })))
                }
                function T(e) {
                    e ? A() : w()
                ...
                var k, _, x, N, S, D, I = "md-tooltip-" + a.nextUid(), H = a.getParentWithPointerEvents(g), O = o.throttle($), P = !1, L = null;
                v(),
                E(),
                g.detach(),
                $(),
        ...
        function o() {
            ...
            function o(t, o, i) {
                var d = r[t] = r[t] || [];
                d.length || (i ? e.addEventListener(t, n, !0) : a.on(t, n)),
            ...
            function i(t, o, i) {
                var d = r[t]
                  , s = d ? d.indexOf(o) : -1;
                s > -1 && (d.splice(s, 1),
                0 === d.length && (i ? e.removeEventListener(t, n, !0) : a.off(t, n)))
            }
            var r = {}
              , a = t.element(e);
            return {
        ...
        n.$inject = ["$timeout", "$window", "$$rAF", "$document", "$interpolate", "$mdUtil", "$mdPanel", "$$mdTooltipRegistry"],
        t.module("material.components.tooltip", ["material.core", "material.components.panel"]).directive("mdTooltip", n).service("$$mdTooltipRegistry", o)
    }(),
    function() {
        function e() {
            return {
        ...
        n.$inject = ["$element"],
        t.module("material.components.truncate", ["material.core"]).directive("mdTruncate", e)
    }(),
    function() {
        function e() {
            return {
        ...
        function o(e, n, o, i, r, a, d, s, c) {
            ...
            this.maxElementPixels = o.ELEMENT_MAX_PIXELS,
            this.$attrs.mdTopIndex ? (this.bindTopIndex = i(this.$attrs.mdTopIndex),
            ...
            this.scroller = s[0].querySelector(".md-virtual-repeat-scroller"),
        ...
        o.$inject = ["$$rAF", "$mdUtil", "$mdConstant", "$parse", "$rootScope", "$window", "$scope", "$element", "$attrs"],
        r.$inject = ["$scope", "$element", "$attrs", "$browser", "$document", "$rootScope", "$$rAF", "$mdUtil"],
        i.$inject = ["$parse"],
        t.module("material.components.virtualRepeat", ["material.core", "material.components.showHide"]).directive("mdVirtualRepeatContainer", e).directive("mdVirtualRepeat", i).directive("mdForceHeight", d);
        var s = 3;
        ...
        o.prototype.sizeScroller_ = function(e) {
            ...
            e < this.maxElementPixels)
                ...
                i.style[t] = this.maxElementPixels + "px",
                i.style[n] = "1px";
                for (var r = 0; r < o; r++)
        ...
        o.prototype.handleScroll_ = function() {
            ...
            e || this.maxSize || (this.scroller.scrollLeft = this.scrollSize,
            ...
            if (!(t === this.scrollOffset || t > this.scrollSize - this.size)) {
                ...
                if (n) {
                    ...
                    this.bindTopIndex) {
                        ...
                        r !== this.topIndex && r < this.repeater.getItemCount() && (this.topIndex = r,
        ...
        r.prototype.virtualRepeatUpdate_ = function(e, n) {
            ...
            if (this.items && o < this.items.length && 0 !== this.container.getScrollOffset()) {
                ...
                this.container.scrollTo(r)
            }
            o !== this.itemsLength && (i = !0,
            this.itemsLength = o),
            this.items = e,
            ...
            for (var l = a - 1; a < this.newEndIndex; a++)
                ...
                this.updateBlock_(d, a),
                c.push(d);
            if (s.length && this.parentNode.insertBefore(this.domFragmentFromBlocks_(s), this.$element[0].nextSibling),
            c.length && this.parentNode.insertBefore(this.domFragmentFromBlocks_(c), this.blocks[l] && this.blocks[l].element[0].nextSibling),
    ...
    function() {
        function e(e, d, s, c, l, m, u, p, h, f, g, b) {
            ...
            function $() {
                ...
                function n() {
                    var e = Ae.scrollContainer.getBoundingClientRect()
                      , t = {};
                    e.right > p.right - r && (t.left = m.right - e.width + "px"),
                    Ae.$.scrollContainer.css(t)
                }
                if (!Ae)
                    return s.nextTick($, !1, e);
                var c, l = (e.dropdownItems || i) * o, m = Ae.wrap.getBoundingClientRect(), u = Ae.snap.getBoundingClientRect(), p = Ae.root.getBoundingClientRect(), f = u.bottom - p.top, g = p.bottom - u.top, b = m.left - p.left, v = m.width, E = t(), y = e.dropdownPosition;
                if (y || (y = f > g && p.height - f - r < l ? "top" : "bottom"),
                h.mdFloatingLabel && (b += a,
                v -= 2 * a),
                c = {
                    left: b + "px",
                    minWidth: v + "px",
                ...
                "top" === y)
                    c.top = "auto",
                    c.bottom = g + "px",
                    c.maxHeight = Math.min(l, m.top - p.top - r) + "px";
                else {
                    var C = p.bottom - m.bottom - r + s.getViewportTop();
                    c.top = f - E + "px",
                    c.bottom = "auto",
                    c.maxHeight = Math.min(l, C) + "px"
                }
                Ae.$.scrollContainer.css(c),
                s.nextTick(n, !1)
            }
            function y() {
                Ae.$.root.length && (l(Ae.$.scrollContainer),
                Ae.$.scrollContainer.detach(),
                Ae.$.root.append(Ae.$.scrollContainer),
                u.pin && u.pin(Ae.$.scrollContainer, p))
            }
            function C() {
                Ae.input.focus()
            }
            function M() {
                ...
                e.$watch("searchText", n ? s.debounce(B, n) : B),
                e.$watch("selectedItem", H),
                t.element(m).on("resize", Ie),
                e.$on("$destroy", T)
            }
            function T() {
                if (Ce.hidden || s.enableScrolling(),
                t.element(m).off("resize", Ie),
                Ae) {
            ...
            function w() {
                ...
                Ae.li = Ae.ul.getElementsByTagName("li"),
                Ae.$ = _(Ae),
                De = Ae.$.input.controller("ngModel")
            }
            function k() {
                var e, n;
                for (e = d; e.length && (n = e.attr("md-autocomplete-snap"),
                !t.isDefined(n)); e = e.parent())
                    ;
                if (e.length)
                    return {
                        snap: e[0],
            ...
            function x(e, n) {
                !e && n ? ($(),
                ue(!0, He.Count | He.Selected),
                Ae && (s.disableScrollAround(Ae.ul),
                Se = N(t.element(Ae.wrap)))) : e && !n && (s.enableScrolling(),
                Se && (Se(),
                Se = null))
            }
            function N(e) {
            ...
            function B(t, n) {
                Ce.index = K(),
                t !== n && (E(),
                V(e.selectedItem).then(function(o) {
            ...
            function V(n) {
                ...
                return f.when(o(n) || n).then(function(e) {
                    return e && !t.isString(e) && g.warn("md-autocomplete: Could not resolve display value to a string. Please check the `md-item-text` attribute."),
                    e
                })
            }
            function Y(e) {
            ...
            function ue(e, t) {
                var n = e ? "polite" : "assertive"
                  , o = [];
                t & He.Selected && Ce.index !== -1 && o.push(ie()),
                t & He.Count && o.push(f.resolve(pe())),
                f.all(o).then(function(e) {
                    b.announce(e.join(" "), n)
                })
            }
            function pe() {
            ...
            Ce.listLeave = D,
            Ce.mouseUp = I,
            Ce.getCurrentDisplayValue = ie,
            Ce.registerSelectedItemWatcher = R,
            Ce.unregisterSelectedItemWatcher = F,
            Ce.notFoundVisible = be,
            Ce.loadingIsVisible = oe,
            Ce.positionDropdown = $;
            var He = {
                Count: 1,
                Selected: 2
        ...
        e.$inject = ["$scope", "$element", "$mdUtil", "$mdConstant", "$mdTheming", "$window", "$animate", "$rootElement", "$attrs", "$q", "$log", "$mdLiveAnnouncer"],
        ...
        function e(e) {
            return {
                ...
                compile: function(e, n) {
                    ...
                    function(e, n, o, i) {
                        i.hasNotFound = !!n.attr("md-has-not-found"),
                        t.isDefined(o.mdClearButton) || e.floatingLabel || (e.clearButton = !0)
                    }
                },
                template: function(t, n) {
                    ...
                    var d = i()
                      ...
                      , c = t.html()
                      , l = n.tabindex;
                    return d && t.attr("md-has-not-found", !0),
                    t.attr("tabindex", "-1"),
    ...
    function() {
        function e(e, t, o, i, r, a, d) {
            ...
            this.items = [],
            this.selectedChip = -1,
            this.enableChipEdit = d.parseAttributeBoolean(t.mdEnableChipEdit),
            this.addOnBlur = d.parseAttributeBoolean(t.mdAddOnBlur),
        ...
        e.prototype.init = function() {
            var e = this;
            e.wrapperId = "_md-chips-wrapper-" + e.$mdUtil.nextUid(),
            e.$scope.$watchCollection("$mdChipsCtrl.items", function() {
                e.setupInputAria(),
                e.setupWrapperAria()
            }),
        ...
        e.prototype.setupWrapperAria = function() {
            ...
            this.items && this.items.length ? (t.attr("role", "listbox"),
            this.contentIds = this.items.map(function() {
                return e.wrapperId + "-chip-" + e.$mdUtil.nextUid()
            }),
            t.attr("aria-owns", this.contentIds.join(" "))) : (t.removeAttr("role"),
        ...
        e.prototype.removeChipAndFocusInput = function(e) {
            this.removeChip(e),
            this.autocompleteCtrl ? (this.autocompleteCtrl.hidden = !0,
        ...
        e.prototype.onInputBlur = function() {
            ...
            this.shouldAddOnBlur() && (this.appendChip(this.getChipBuffer().trim()),
            this.resetChipBuffer())
        }
        ,
        ...
        e.prototype.shouldAddOnBlur = function() {
            ...
            return this.userInputNgModelCtrl && (t = t && this.userInputNgModelCtrl.$valid),
        ...
        function e(e, t) {
            function o(n, o) {
                return function(n, i, r, a) {
                    ...
                    e(i),
                    i.attr("tabindex", "-1"),
                    r.$observe("mdChipAppendDelay", function(e) {
                        d.chipAppendDelay = e
                    })
                }
            }
    ...
    function() {
        !function() {
            ...
            function n(e, n, o, r, a, d, s, c, l) {
                ...
                m = e.parent().hasClass("md-datepicker-calendar") ? t.element(document.body) : e,
                m.on("keydown", u),
                n.$on("$destroy", function() {
                    m.off("keydown", u)
                }),
            ...
            n.$inject = ["$element", "$scope", "$$mdDateUtil", "$mdUtil", "$mdConstant", "$mdTheming", "$$rAF", "$attrs", "$mdDateLocale"],
            ...
            n.prototype.$onInit = function() {
                ...
                this.minDate && this.minDate > e.firstRenderableDate ? this.firstRenderableDate = this.minDate : this.firstRenderableDate = e.firstRenderableDate,
                this.maxDate && this.maxDate < e.lastRenderableDate ? this.lastRenderableDate = this.maxDate : this.lastRenderableDate = e.lastRenderableDate
            }
            ,
                ...
                t.prototype.$get = function(e, t) {
                    function n(e, n) {
                        ...
                        var o = e.toLocaleTimeString()
                          , i = e;
                        return 0 !== e.getHours() || o.indexOf("11:") === -1 && o.indexOf("23:") === -1 || (i = new Date(e.getFullYear(),e.getMonth(),e.getDate(),1,0,0)),
                        t("date")(i, "M/d/yyyy", n)
                    }
                    function o(e) {
                        return new Date(e)
    ...
    function() {
        !function() {
                ...
                return {
                    template: function(t, n) {
                        var o = n.mdHideIcons
                          ...
                          , a = "";
                        return "all" !== o && "triangle" !== o && (a = '<md-button type="button" md-no-ink class="md-datepicker-triangle-button md-icon-button" ng-click="ctrl.openCalendarPane($event)" aria-label="{{::ctrl.locale.msgOpenCalendar}}"><div class="md-datepicker-expand-triangle"></div></md-button>',
                        t.addClass(c)),
                        r + '<div class="md-datepicker-input-container" ng-class="{\'md-datepicker-focused\': ctrl.isFocused}"><input ' + (i ? 'aria-label="' + i + '" ' : "") + 'class="md-datepicker-input" aria-haspopup="true" aria-expanded="{{ctrl.isCalendarOpen}}" ng-focus="ctrl.setFocused(true)" ng-blur="ctrl.setFocused(false)"> ' + a + '</div><div class="md-datepicker-calendar-pane md-whiteframe-z1" id="{{::ctrl.calendarPaneId}}"><div class="md-datepicker-input-mask"><div class="md-datepicker-input-mask-opaque"></div></div><div class="md-datepicker-calendar"><md-calendar role="dialog" aria-label="{{::ctrl.locale.msgCalendar}}" md-current-view="{{::ctrl.currentView}}"md-min-date="ctrl.minDate"md-max-date="ctrl.maxDate"md-date-filter="ctrl.dateFilter"ng-model="ctrl.date" ng-if="ctrl.isCalendarOpen"></md-calendar></div></div>'
                    },
                    ...
                    link: function(e, o, a, c) {
                        ...
                        if (m.configureNgModel(l, u, r),
                        u) {
                            var f = o[0].querySelector(".md-errors-spacer");
                            f && o.after(t.element("<div>").append(f)),
                            u.setHasPlaceholder(a.mdPlaceholder),
                            u.input = o,
                            u.element.addClass(d).toggleClass(s, "calendar" !== a.mdHideIcons && "all" !== a.mdHideIcons),
                            u.label ? h || a.$observe("required", function(e) {
                                u.label.toggleClass("md-required", !!e)
                            }) : i.expect(o, "aria-label", a.mdPlaceholder),
                            e.$watch(u.isErrorGetter || function() {
            ...
            function o(n, o, i, r, a, d, s, c, l, m, u) {
                ...
                this.ngModelCtrl = null,
                this.inputElement = o[0].querySelector("input"),
                this.ngInputElement = t.element(this.inputElement),
                this.inputContainer = o[0].querySelector(".md-datepicker-input-container"),
                this.calendarPane = o[0].querySelector(".md-datepicker-calendar-pane"),
                this.calendarButton = o[0].querySelector(".md-datepicker-button"),
                this.inputMask = t.element(o[0].querySelector(".md-datepicker-input-mask-opaque")),
                this.$element = o,
                this.$attrs = i,
                this.$scope = n,
                this.date = null,
                this.isFocused = !1,
                this.isDisabled,
                this.setDisabled(o[0].disabled || t.isString(i.disabled)),
                this.isCalendarOpen = !1,
                this.openOnFocus = i.hasOwnProperty("mdOpenOnFocus"),
                this.mdInputContainer = null,
                this.calendarPaneOpenedFrom = null,
                this.calendarPaneId = "md-date-pane-" + s.nextUid(),
                this.bodyClickHandler = t.bind(this, this.handleBodyClick),
                this.windowEventName = p.test(navigator.userAgent || navigator.vendor || e.opera) ? "orientationchange" : "resize",
                this.windowEventHandler = s.debounce(t.bind(this, this.closeCalendarPane), 100),
                this.windowBlurHandler = t.bind(this, this.handleWindowBlur),
                this.ngDateFilter = u("date"),
                this.leftMargin = 20,
                this.topMargin = null,
                i.tabindex ? (this.ngInputElement.attr("tabindex", i.tabindex),
                i.$set("tabindex", null)) : i.$set("tabindex", "-1"),
                i.$set("aria-owns", this.calendarPaneId),
                d(o),
                d(t.element(this.calendarPane));
                var h = this;
                n.$on("$destroy", function() {
            ...
            o.$inject = ["$scope", "$element", "$attrs", "$window", "$mdConstant", "$mdTheming", "$mdUtil", "$mdDateLocale", "$$mdDateUtil", "$$rAF", "$filter"],
            n.$inject = ["$$mdSvgRegistry", "$mdUtil", "$mdAria", "inputDirective"],
            ...
            o.prototype.$onInit = function() {
                this.locale = this.dateLocale ? t.extend({}, this.$mdDateLocale, this.dateLocale) : this.$mdDateLocale,
            ...
            o.prototype.configureNgModel = function(e, n, o) {
                ...
                i.ngModelCtrl.$formatters.push(function(e) {
                    ...
                    if (!isNaN(n) && t.isNumber(n) && (e = new Date(n)),
                    e && !(e instanceof Date))
                        throw Error("The ng-model for md-datepicker must be a Date instance or a value that can be parsed into a date. Currently the model is of type: " + typeof e);
                    return i.onExternalChange(e),
                    e
                }),
    ...
    function() {
        function e(e, t, n, o) {
            function i(o, i, r) {
                ...
                a(),
                r.$observe("mdFontIcon", d),
                r.$observe("mdFontSet", d);
                var l = (i[0].getAttribute(r.$attr.mdSvgSrc),
                r.$normalize(r.$attr.mdSvgIcon || r.$attr.mdSvgSrc || ""));
                if (r.role || (n.expect(i, "role", "img"),
                r.role = "img"),
                "img" === r.role && !r.ariaHidden && !n.hasAriaLabel(i)) {
                    var m;
    ...
    function() {
        function e(e, o, i, r, a, d, s, c, l) {
            ...
            this.init = function(n, o) {
                o = o || {},
                m = n,
                u = i[0].querySelector(p.buildSelector(["ng-click", "ng-mouseenter"])),
                u.setAttribute("aria-expanded", "false"),
                this.isInMenuBar = o.isInMenuBar,
                this.nestedMenus = a.nodesToArray(m[0].querySelectorAll(".md-nested-menu")),
                m.on("$mdInterimElementRemove", function() {
                    h.isOpen = !1,
                    a.nextTick(function() {
            ...
            this.enableHoverListener = function() {
                b.push(s.$on("$mdMenuOpen", function(e, t) {
                    m[0].contains(t[0]) && (h.currentlyOpenMenu = t.controller("mdMenu"),
                    h.isAlreadyOpening = !1,
                    h.currentlyOpenMenu.registerContainerProxy(h.triggerContainerProxy.bind(h)))
                })),
                b.push(s.$on("$mdMenuClose", function(e, t) {
                    m[0].contains(t[0]) && (h.currentlyOpenMenu = n)
                })),
                g = t.element(a.nodesToArray(m[0].children[0].children)),
                g.on("mouseenter", h.handleMenuItemHover),
                g.on("mouseleave", h.handleMenuItemMouseLeave)
            }
            ,
            this.disableHoverListener = function() {
                for (; b.length; )
                    b.shift()();
                g && g.off("mouseenter", h.handleMenuItemHover),
                g && g.off("mouseleave", h.handleMenuItemMouseLeave)
            }
            ,
            this.handleMenuItemHover = function(e) {
                if (!h.isAlreadyOpening) {
                    ...
                    f = d(function() {
                        ...
                        h.currentlyOpenMenu && h.currentlyOpenMenu != n) {
                            var e = h.nestLevel + 1;
                            h.currentlyOpenMenu.close(!0, {
                                closeTo: e
                            }),
                            h.isAlreadyOpening = !!n,
                            n && n.open()
                        } else
                            n && !n.isOpen && n.open && (h.isAlreadyOpening = !!n,
                            n && n.open())
                    }, n ? 100 : 250);
            ...
            this.open = function(t) {
                t && t.stopPropagation(),
                t && t.preventDefault(),
                h.isOpen || (h.enableHoverListener(),
                h.isOpen = !0,
                a.nextTick(function() {
                    h.onIsOpenChanged(h.isOpen)
                }),
            ...
            r.$mdOpenMenu = t.bind(this, function() {
                return l.warn("mdMenu: The $mdOpenMenu method is deprecated. Please use `$mdMenu.open`."),
    ...
    function() {
        function e(e) {
            function n(n) {
                ...
                if (r && s && !r.hasAttribute("type") && r.setAttribute("type", "button"),
                !r)
                ...
                return c && t.forEach(e.nodesToArray(c), function(e) {
                    ...
                    e.setAttribute("md-nest-level", l + 1)
                }),
                o
            }
            function o(e, n, o, i) {
        ...
        function e(e) {
            function o(e, o, a, d, s, c, l, m, u, p) {
                ...
                function g(n, i, r) {
                    ...
                    function g() {
                        return r.backdrop ? (r.backdrop.on("click", v),
                        function() {
                    ...
                    function E() {
                        function o(t) {
                            ...
                            case a.KEY_CODE.UP_ARROW:
                                b(t, r.menuContentEl, r, -1) || r.nestLevel || r.mdMenuCtrl.triggerContainerProxy(t),
                                n = !0;
                                break;
                        ...
                        if (!r.menuContentEl[0])
                            return t.noop;
                        r.menuContentEl.on("keydown", o),
                        r.menuContentEl[0].addEventListener("click", i, !0);
                        ...
                        if (!d)
                            for (var s = r.menuContentEl[0].children.length, c = 0; c < s; c++) {
                                ...
                                if (d = l.querySelector(".md-button:not([disabled])"))
                                    break;
                        ...
                        return d && d.focus(),
                        function() {
                            r.menuContentEl.off("keydown", o),
                            r.menuContentEl[0].removeEventListener("click", i, !0)
                        }
                    }
                    return u(r),
                    r.menuContentEl[0] ? o.inherit(r.menuContentEl, r.target) : p.warn("$mdMenu: Menu elements should always contain a `md-menu-content` element,otherwise interactivity features will not work properly.", i),
                    r.cleanupResizing = f(),
                    r.hideBackdrop = h(n, i, r),
                    d().then(function(e) {
                        return r.alreadyOpen = !0,
                        r.cleanupInteraction = E(),
                        r.cleanupBackdrop = g(),
                ...
                function $(t, o) {
                    ...
                    var c, l = t[0], m = t[0].firstElementChild, u = m.getBoundingClientRect(), p = d[0].body, h = p.getBoundingClientRect(), f = s.getComputedStyle(m), g = o.target[0].querySelector(y.buildSelector("md-menu-origin")) || o.target[0], b = g.getBoundingClientRect(), v = {
                        left: h.left + r,
                    ...
                    "target" != C.top && "target" != C.left && "target-right" != C.left || (c = a(),
                    c && (c = c.firstElementChild || c,
                    c = c.querySelector(y.buildSelector("md-menu-align-target")) || c,
    ...
    function() {
        ...
        e.prototype.enableOpenOnHover = function() {
            if (!this.openOnHoverEnabled) {
                ...
                e.parentToolbar && (e.parentToolbar.classList.add("md-has-open-menu"),
                e.$mdUtil.nextTick(function() {
                    t.element(e.parentToolbar).on("click", e.handleParentClick)
                }, !1)),
                t.element(e.getMenus()).on("mouseenter", e.handleMenuHover)
            }
        }
        ,
            ...
            return {
                ...
                compile: function(n, i) {
                    ...
                    if ("checkbox" != d && "radio" != d || !n.hasClass(s))
                        ...
                        l.attr("tabindex", "0"),
                        n.html(""),
                        n.append(t.element(m)),
                        n.append(l),
                        n.addClass("md-indent").removeClass(s),
                        r("role", "checkbox" == d ? "menuitemcheckbox" : "menuitemradio", l),
                        a("ng-disabled")
                    }
                    return function(e, t, n, o) {
                        var i = o[0]
        ...
        function e(e, n, o, i, r, a) {
            function d(a, d, E) {
                function $(t, o, r, d, s, l) {
                    function h(e) {
                        _.attr("stroke-dashoffset", c(v, E, e, M)),
                        _.attr("transform", "rotate(" + C + " " + v / 2 + " " + v / 2 + ")")
                    }
                    var f = ++D
                      , g = i.now()
                      , b = o - t
                ...
                function y() {
                    $(x, N, n.easeFnIndeterminate, n.durationIndeterminate, S, 75),
                    S = ++S % 4
                }
                function C() {
                    A || (A = r(y, n.durationIndeterminate, 0, !1),
                    y(),
                    d.addClass(v).removeAttr("aria-valuenow"))
                }
                function M() {
                    A && (r.cancel(A),
                    A = null,
                ...
                var T, A, w = d[0], k = t.element(w.querySelector("svg")), _ = t.element(w.querySelector("path")), x = n.startIndeterminate, N = n.endIndeterminate, S = 0, D = 0;
                o(d),
                d.toggleClass(b, E.hasOwnProperty("disabled")),
                a.mdMode === g && C(),
                a.$on("$destroy", function() {
                    M(),
                    T && h(T)
                ...
                a.$watch("mdDiameter", function(t) {
                    ...
                    k[0].setAttribute("viewBox", "0 0 " + n + " " + n),
                    k.css(p).css("transform-origin", r + " " + r + " " + r),
                    d.css(p),
                    _.attr("stroke-width", o),
                    _.attr("stroke-linecap", "square"),
                    a.mdMode == g ? (_.attr("d", s(n, o, !0)),
                    _.attr("stroke-dasharray", (n - o) * e.Math.PI * .75),
                    _.attr("stroke-dashoffset", c(n, o, 1, 75))) : (_.attr("d", s(n, o, !1)),
                    _.attr("stroke-dasharray", (n - o) * e.Math.PI),
                    _.attr("stroke-dashoffset", c(n, o, 0, 100)),
                    $(i, i))
                })
            }
            function s(e, t, n) {
    ...
    function() {
        function e(e, o, i, r, a, d, s, c, l, m, u, p) {
            function h() {
                E("stretchTabs", C),
                X("focusIndex", _, he.selectedIndex || 0),
                X("offsetLeft", k, 0),
                X("hasContent", w, !1),
                X("maxTabWidth", T, J()),
                X("shouldPaginate", A, !1),
                $("noInkBar", R),
                $("dynamicHeight", F),
                $("noPagination"),
                $("swipeContent"),
                ...
                he.parent = e.$parent,
                he.tabs = [],
                he.lastSelectedIndex = null,
                he.hasFocus = !1,
                he.styleTabItemFocus = !1,
                he.shouldCenterTabs = Y(),
                he.tabContentPrefix = "tab-content-",
                f()
            }
            function f() {
                he.selectedIndex = he.selectedIndex || 0,
                g(),
                v(),
                b(),
                m(o),
                d.nextTick(function() {
                    ...
                    oe(),
                    se(),
                    he.tabs[he.selectedIndex] && he.tabs[he.selectedIndex].scope.select(),
                    Ee = !0,
                    Q()
                })
            }
            function g() {
                ...
                n.html(e),
                l(n.contents())(he.parent),
                delete c.$mdTabsTemplate
            }
            function b() {
                t.element(i).on("resize", L),
                e.$on("$destroy", y)
            }
            function v() {
            ...
            function y() {
                ve = !0,
                t.element(i).off("resize", L)
            }
            function C(e) {
                var n = U();
                t.element(n.wrapper).toggleClass("md-stretch-tabs", V()),
                se()
            }
            function M(e) {
                he.shouldCenterTabs = Y()
            ...
            function x(t, n) {
                t !== n && (he.selectedIndex = G(t),
                he.lastSelectedIndex = n,
                he.updateInkBarStyles(),
                de(),
                oe(t),
                e.$broadcast("$mdTabsChanged"),
                he.tabs[n] && he.tabs[n].scope.deselect(),
                he.tabs[t] && he.tabs[t].scope.select())
            }
            function N(e) {
            ...
            function S() {
                S.watcher || (S.watcher = e.$watch(function() {
                    d.nextTick(function() {
                        S.watcher && o.prop("offsetParent") && (S.watcher(),
                        S.watcher = null,
                        L())
                    }, !1)
                }))
            ...
            function I(e, t) {
                fe || (he.focusIndex = he.selectedIndex = e),
                t && he.noSelectClick || d.nextTick(function() {
                    he.tabs[e].element.triggerHandler("click")
                }, !1)
            }
            function H(e) {
                he.shouldPaginate && (e.preventDefault(),
                he.offsetLeft = le(he.offsetLeft - e.wheelDelta))
            }
            function O() {
            ...
            function L() {
                ...
                he.offsetLeft = le(he.offsetLeft),
                d.nextTick(function() {
                    he.updateInkBarStyles(),
                    Q()
                })
            ...
            function B(e) {
                if (!ve) {
                    ...
                    ae(),
                    he.selectedIndex === t && (n.scope.deselect(),
                    he.tabs[he.selectedIndex] && he.tabs[he.selectedIndex].scope.select()),
                    d.nextTick(function() {
                        Q(),
                        he.offsetLeft = le(he.offsetLeft)
            ...
            function j(e, n) {
                var o = Ee
                  ...
                  , r = t.extend(i, e);
                return t.isDefined(n) ? he.tabs.splice(n, 0, r) : he.tabs.push(r),
                ie(),
                re(),
                d.nextTick(function() {
                    Q(),
                    ue(r),
                    o && he.autoselect && d.nextTick(function() {
                        d.nextTick(function() {
                            I(he.tabs.indexOf(r))
                        })
                    })
            ...
            function te(e, t) {
                ...
                for (n = i + e; he.tabs[n] && he.tabs[n].scope.disabled; n += e)
                    ;
                n = (i + e + he.tabs.length) % he.tabs.length,
                he.tabs[n] && (he[o] = n)
            }
            function ne() {
                he.styleTabItemFocus = "keyboard" === u.getLastInteractionType(),
                U().tabs[he.focusIndex].focus()
            }
            function oe(e) {
                var n = U();
                if (t.isNumber(e) || (e = he.focusIndex),
                n.tabs[e] && !he.shouldCenterTabs) {
                    var o = n.tabs[e]
                      , i = o.offsetLeft
                      , r = o.offsetWidth + i
                      , a = 32;
                    if (0 == e)
                        return void (he.offsetLeft = 0);
                    if (pe()) {
                        var d = Z(Array.prototype.slice.call(n.tabs, 0, e))
                          , s = Z(Array.prototype.slice.call(n.tabs, 0, e + 1));
                        he.offsetLeft = Math.min(he.offsetLeft, le(d)),
                        he.offsetLeft = Math.max(he.offsetLeft, le(s - n.canvas.clientWidth))
                    } else
                        he.offsetLeft = Math.max(he.offsetLeft, le(r - n.canvas.clientWidth + a)),
                        he.offsetLeft = Math.min(he.offsetLeft, le(i))
                }
            }
            function ie() {
            ...
            function ae() {
                he.selectedIndex = G(he.selectedIndex),
                he.focusIndex = G(he.focusIndex)
            }
            function de() {
                if (!he.dynamicHeight)
                    return o.css("height", "");
            ...
            function se() {
                var e = U();
                if (!e.tabs[he.selectedIndex])
                    return void t.element(e.inkBar).css({
                        left: "auto",
                        right: "auto"
                    });
                if (!he.tabs.length)
                    return be.push(he.updateInkBarStyles);
            ...
            function le(e) {
                var t = U();
                if (!t.tabs.length || !he.shouldPaginate)
                    return 0;
                var n = t.tabs[t.tabs.length - 1]
                  , o = n.offsetLeft + n.offsetWidth;
                return pe() ? (e = Math.min(t.paging.offsetWidth - t.canvas.clientWidth, e),
                e = Math.max(0, e)) : (e = Math.max(0, e),
            ...
            var he = this
              ...
              , Ee = !1;
            he.$onInit = h,
            he.updatePagination = d.debounce(Q, 100),
            he.redirectFocus = ne,
            he.attachRipple = me,
            he.insertTab = j,
            he.removeTab = B,
            ...
            he.canPageBack = q,
            he.refreshIndex = ae,
            he.incrementIndex = te,
            he.getTabElementIndex = N,
            he.updateInkBarStyles = d.debounce(se, 100),
            he.updateTabOrder = d.debounce(ee, 100),
            he.getFocusedTabId = W,
            1 === t.version.major && t.version.minor <= 4 && this.$onInit()
        }
                ...
                link: function(n, o, i, r) {
                    if (r) {
                        ...
                        if ("MutationObserver"in t) {
                            ...
                            a.observe(o[0], c),
                            d = a.disconnect.bind(a)
                        } else {
                            var l = e.debounce(s, 15, null, !1);
                            o.on("DOMSubtreeModified", l),
                            d = o.off.bind(o, "DOMSubtreeModified", l)
                        }
                        n.$on("$destroy", function() {
                            d()
                        })
