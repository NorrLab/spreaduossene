...
angular.module('ui-notification').provider('Notification', function () {
    ...
    this.$get = ["$timeout", "$http", "$compile", "$templateCache", "$rootScope", "$injector", "$sce", "$q", "$window", "$translate", function ($timeout, $http, $compile, $templateCache, $rootScope, $injector, $sce, $q, $window, $translate) {
        ...
        var notify = function (args, t, error) {
            ...
            $http.get(args.template, {cache: $templateCache}).success(function (template) {
                ...
                var defaultErrorMessage = $rootScope.defaultErrorMessage;

                if (error) {
                    scope.message = args.message ? $sce.trustAsHtml(args.message) : defaultErrorMessage;
                } else {
        ...
        notify.error = function (args) {
            return this(args, 'error', true);
        };
        notify.success = function (args) {
            return this(args, 'success', false);
        };
        notify.info = function (args) {
            return this(args, 'info', false);
        };
